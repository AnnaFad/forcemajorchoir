...
<Footer style={{ textAlign: 'center', backgroundColor: '#0c0d40', paddingTop: '3%', paddingBottom:'3%'}}>
    <Row gutter={24} style={{textAlign: 'start', marginRight: '5%', marginLeft: '5%'}}>
      ...
      <Col className="gutter-row" span={6}>
        <div >
        <p><Link to='https://vk.com/hsechoir' style={{color: 'white', fontFamily: 'pragmatica', fontWeight: 'lighter', fontSize: '200%'}}>VK</Link></p>
        <p><Link to='https://youtube.com/@forcemajorchoir?si=A3JW9XNMFuKb8rCt' style={{color: 'white', fontFamily: 'pragmatica', fontWeight: 'lighter',  fontSize: '200%'}}>YouTube</Link></p>
        <p style={{color: 'white', fontFamily: 'pragmatica', fontWeight: 'lighter'}} >choir.fm@gmail.com</p>
        </div>
      </Col>
    </Row>
    <div>
    ...
    <Row gutter={24} style={{textAlign: 'start', marginRight: '5%', marginLeft: '5%'}}>
      <Col className="gutter-row" span={6}>
        <div>
          <p style={{color: 'white', fontFamily: 'pragmatica', fontWeight: 'lighter', fontSize: '70%'}}>Website created by Anna Fadeeva & Anastasiia Romanyuk</p>
          <p style={{color: 'white', fontFamily: 'pragmatica', fontWeight: 'lighter', fontSize: '70%'}}>Partner designer Ksenia Pichugina</p>
        </div>
      </Col>
      <Col className="gutter-row" span={6}>
        <div>
          ...
          class='footer-text' style={{color:'#bbc0d3'}}>Политика конфиденциальности</Link><p/></p>
        </div>
      </Col>
      <Col className="gutter-row" span={6}>
        <div>
