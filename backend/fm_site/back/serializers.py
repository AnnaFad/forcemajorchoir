...
class RehersalSerializer(serializers.ModelSerializer):
    class Meta:
        model = Rehersal
        fields = ('id', 'title', 'date_start', 'date_end', 'is_last', 'create_at', 'update_at')
...
class EventSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'name_event', 'description', 'event_time', 'photo', 'has_registration', 
                  'limit_people', 'date_time_open', 'date_time_close', 'is_deleted', 'create_at', 'update_at')
...
class CustomUserSerializer(serializers.ModelSerializer):
    class Meta:
        model = CustomUser
        fields = [ 'username', 'email', 'role_user', 'password']
